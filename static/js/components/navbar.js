...
function getCurrentPage() {
    ...
    var currentPage = pathArray.pop(); // Get the last segment of the path
    // If the last segment is empty (e.g., URL ends with '/'), get the previous segment
    if (currentPage === '') {
        currentPage = pathArray.pop();
